...
static rt_err_t _uart_cfg(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    nrf_uart_disable(instance->uart.uart.p_reg);
    ...
    nrf_uart_baudrate_set(instance->uart.uart.p_reg, config.baudrate);
    nrf_uart_configure(instance->uart.uart.p_reg, config.parity, config.hwfc);
    nrf_uart_txrx_pins_set(instance->uart.uart.p_reg, config.pseltxd, config.pselrxd);

    if (config.hwfc == NRF_UART_HWFC_ENABLED)
    {
        nrf_uart_hwfc_pins_set(instance->uart.uart.p_reg, config.pselrts, config.pselcts);
    }

    nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_TXDRDY);
    nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_RXDRDY);
    nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_RXTO);
    nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_ERROR);

    nrf_uart_int_enable(instance->uart.uart.p_reg, NRF_UART_INT_MASK_RXDRDY | NRF_UART_INT_MASK_RXTO | NRF_UART_INT_MASK_ERROR);
    NRFX_IRQ_PRIORITY_SET(nrfx_get_irq_number((void *)instance->uart.uart.p_reg), config.interrupt_priority);
    NRFX_IRQ_ENABLE(nrfx_get_irq_number((void *)instance->uart.uart.p_reg));

    nrf_uart_enable(instance->uart.uart.p_reg);
    // nrf_uart_task_trigger(instance->uart.uart.p_reg, NRF_UART_TASK_STARTRX);
...
static rt_err_t _uart_ctrl(struct rt_serial_device *serial, int cmd, void *arg)
{
    ...
    case RT_DEVICE_CTRL_CLR_INT:
        nrf_uart_task_trigger(instance->uart.uart.p_reg, NRF_UART_TASK_STOPRX);
        nrf_uart_int_disable(instance->uart.uart.p_reg, NRF_UART_INT_MASK_RXDRDY
                                                | NRF_UART_INT_MASK_RXTO
                                                | NRF_UART_INT_MASK_ERROR);
        NRFX_IRQ_DISABLE(nrf_drv_get_IRQn((void *)instance->uart.uart.p_reg));
        break;
    ...
    case RT_DEVICE_CTRL_SET_INT:
        ...
        nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_ERROR);
        /* Enable RX interrupt. */
        nrf_uart_int_enable(instance->uart.uart.p_reg, NRF_UART_INT_MASK_RXDRDY
                                                | NRF_UART_INT_MASK_RXTO
                                                | NRF_UART_INT_MASK_ERROR);

        NRFX_IRQ_PRIORITY_SET(nrfx_get_irq_number((void *)instance->uart.uart.p_reg), APP_IRQ_PRIORITY_LOWEST);
        NRFX_IRQ_ENABLE(nrfx_get_irq_number((void *)instance->uart.uart.p_reg));
    ...
    case RT_DEVICE_CTRL_CUSTOM:
        if ((rt_uint32_t)(arg) == UART_CONFIG_BAUD_RATE_9600)
        {
            ...
            nrf_uart_baudrate_set(instance->uart.uart.p_reg, NRF_UART_BAUDRATE_9600);
        }
        else if ((rt_uint32_t)(arg) == UART_CONFIG_BAUD_RATE_115200)
        {
            instance->serial->config.baud_rate = 115200;
            nrf_uart_baudrate_set(instance->uart.uart.p_reg, NRF_UART_BAUDRATE_115200);
        }
    ...
    case RT_DEVICE_POWERSAVE:
        nrf_uart_disable(instance->uart.uart.p_reg);
        nrf_uart_txrx_pins_disconnect(instance->uart.uart.p_reg);
...
static int _uart_putc(struct rt_serial_device *serial, char c)
{
    ...
    nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_TXDRDY);
    nrf_uart_task_trigger(instance->uart.uart.p_reg, NRF_UART_TASK_STARTTX);
    nrf_uart_txd_set(instance->uart.uart.p_reg, (uint8_t)c);
    while (!nrf_uart_event_check(instance->uart.uart.p_reg, NRF_UART_EVENT_TXDRDY))
    {
    }
...
static int _uart_getc(struct rt_serial_device *serial)
{
    ...
    if (nrf_uart_event_check(instance->uart.uart.p_reg, NRF_UART_EVENT_RXDRDY))
    {
        nrf_uart_event_clear(instance->uart.uart.p_reg, NRF_UART_EVENT_RXDRDY);
        ch = (int)(nrf_uart_rxd_get(instance->uart.uart.p_reg));
    }
